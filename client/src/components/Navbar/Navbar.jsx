  ...
  return (
    <nav
      ...
      style={{
        height: "4rem",
        background:
          "linear-gradient(120deg, rgba(255,255,255,0.9), rgba(236,252,255,0.85), rgba(230,242,255,0.9), rgba(238,242,255,0.85))",
    ...
    >
      ...
      {isMobile && (
        <div className="close-icon" onClick={closeMenuBar}>
          <TfiClose />
        </div>
      )}
      ...
      >
        ...
        <div
          id="nav-links-a"
          className={`${getLinkClasses("/services")} nav-link-aa`}
      ...
      >
        <button
          className="nav-links-login relative overflow-hidden bg-white/95 text-gray-800 border-2 border-gray-100/80 px-7 py-2 rounded-xl transition-all duration-300 hover:shadow-[0_8px_30px_rgba(59,130,246,0.2)] hover:border-blue-300 hover:text-blue-600 font-medium transform hover:-translate-y-0.5 hover:bg-gradient-to-r hover:from-white hover:to-blue-50 group"
