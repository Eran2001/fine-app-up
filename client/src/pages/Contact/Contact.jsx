      ...
      <div className="container relative mx-auto px-4 py-16">
        ...
        <div className="flex justify-center gap-8 mb-12">
          {["email", "phone", "location"].map((item) => (
            <div
              key={item}
              className="flex items-center gap-3 text-gray-600 dark:text-gray-300 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm px-6 py-3 rounded-xl"
            >
        ...
        <div className="max-w-2xl mx-auto">
          <div className="backdrop-blur-xl bg-white/90 dark:bg-gray-800/90 rounded-3xl shadow-2xl p-8 transform transition-all hover:scale-[1.01] border border-gray-100 dark:border-gray-700">
            ...
            {status && status !== "Sending..." && (
              <div
                className={`mt-4 text-center text-sm font-medium p-4 rounded-xl backdrop-blur-sm ${
